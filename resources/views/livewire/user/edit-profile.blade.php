...
<div class="w-full h-full bg-white dark:bg-dark-2 rounded-md">
    <div class="px-4 py-3 border-b border-lightest dark:border-dark flex justify-between">
        <div class="font-mont">
            <div class="text-light text-lg font-bold">General Info</div>
            <div class="text-light text-xs">Edit your account's general information</div>
        </div>
        <div class="text-sm">
            ...
            <div class="mt-10 flex justify-between">
                ...
                <div class="flex h-auto items-end">
                    <div class="w-full flex justify-end relative font-mont">
                        ...
                        <div x-show="socialLink == true" class="absolute w-48 py-2 dark:bg-darkest-1 bg-white border border-lightest rounded-md top-8">
